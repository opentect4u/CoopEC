  ...
  var e,
              ...
              if (k(t.map, "data-ephox-embed-iri"))
                ...
                if (
                  ...
                  ("iframe" !== e &&
                    ...
                    "video" !== e &&
                    "audio" !== e) ||
                    (u.type || (u.type = e), (u = T.extend(t.map, u))),
                  "script" === e)
                ) {
                  var r = D(a, t.map.src);
                  if (!r) return;
            ...
            start: function (e, t, r) {
              if (!m.get())
                if (k(t.map, "data-ephox-embed-iri"))
                  m.set(!0),
                    (n = c),
                    (i = (o = t).map.style),
                    ((a = i ? E.parseStyle(i) : {})["max-width"] = R(n.width)),
                  ...
                  switch (e) {
                    ...
                    case "iframe":
                      c.height !== undefined &&
                        c.width !== undefined &&
                        L(t, { width: c.width, height: c.height });
                  }
                  if (u)
                    switch (e) {
                      case "video":
                        L(t, { poster: c.poster, src: "" }),
                          c.altsource && L(t, { src: "" });
                        break;
                      case "iframe":
                        L(t, { src: c.source });
              ...
              if (!m.get()) {
                ...
                c.poster &&
                  ...
                  !s &&
                  (((n = []).map = {}),
                  L(n, { src: c.poster, width: c.width, height: c.height }),
                  l.start("img", n, !0));
              }
              l.end(e);
            },
                ...
                : ((i = n),
                  (a = h)
                    ...
                    : '<video width="' +
                      ...
                      i.source +
                      '"' +
                      (i.sourcemime ? ' type="' + i.sourcemime + '"' : "") +
                      " />\n" +
                      (i.altsource
                        ? '<source src="' +
                          i.altsource +
    ...
    X = function (e, t) {
      var r,
        ...
        i = V(e, o, t);
      return p(
        p(p(p(p({}, i("source")), i("altsource")), i("poster")), i("embed")),
        ((r = o),
        (n = {}),
    ...
    le = function (e, t, r) {
      var n = "img" === t.name || "video" === e.name,
        ...
        a = n ? i : null;
      t.attr({ width: se(e, r, "width", o), height: se(e, r, "height", a) });
    },
    me = function (e, t) {
      var r = t.name,
        ...
        for (var t, r, n, o, i, a, c, u = e.length; u--; )
          (t = e[u]).parent &&
            (t.parent.attr("data-mce-object") ||
              ("script" === t.name && !(r = D(A(s), t.attr("src")))) ||
              (r &&
    ...
    return (
      ...
      r.on("ObjectResized", function (e) {
        ...
        r.getAttribute("data-mce-object") &&
          ...
          r.setAttribute(
            "data-mce-html",
            escape(q(t, { width: String(e.width), height: String(e.height) })),
          ));
      }),
      (n = e),
      {
