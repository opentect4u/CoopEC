  ...
  var formattedDate = date_ob.format('YYYY-MM-DD HH:mm:ss');
    ...
    //  console.log(res_dt.msg);
      ...
      if (society.tenure_ends_on) {
        ...
        let formattedEndDate = new Date(society.tenure_ends_on).toISOString().split('T')[0]; // Format as YYYY-MM-DD
        ...
        await db_Insert('td_notification', noti_fields, noti_values, null, false);
        var noti_values1 = `('SE', '${message}', '0', 'U', '1', '${society.range_code}', 'SYSTEM', '${formattedDate}', '${ip}')`;
        await db_Insert('td_notification', noti_fields, noti_values1, null, false);
        var noti_values2 = `('SE', '${message}', '0', 'A', '1', '${society.range_code}', 'SYSTEM', '${formattedDate}', '${ip}')`;
        await db_Insert('td_notification', noti_fields, noti_values2, null, false);
        var noti_values3 = `('SE', '${message}', '0', 'S', '1', '${society.range_code}', 'SYSTEM', '${formattedDate}', '${ip}')`;
        await db_Insert('td_notification', noti_fields, noti_values3, null, false);
