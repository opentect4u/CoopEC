...
WdtlsRouter.get('/edit', async(req, res) => {
    try {
...
WdtlsRouter.post('/socedit', async(req, res) => {
  try {
      // Extract range_id from session
...
WdtlsRouter.post('/socadddata', async(req, res) => {
  try {
      // Extract range_id from session
      var user_id = req.session.user.user_id;
...
WdtlsRouter.get('/regauth',async(req,res)=>{
  try {
...
WdtlsRouter.get('/ulblist',async(req,res)=>{
  try {
    // Extract query parameter 'claims'
...
WdtlsRouter.get('/wardlist',async(req,res)=>{
  try {
    // Extract query parameter 'claims'
    const ulb_catg = req.query.ulb_catg;
...
WdtlsRouter.get('/blocklist',async(req,res)=>{
  try {
    // Extract query parameter 'claims'
    const dist_code = req.query.dist_code;
    // In a real application, you might query a database or perform other operations
...
WdtlsRouter.get('/gplist',async(req,res)=>{
  try {
    // Extract query parameter 'claims'
...
WdtlsRouter.get('/villlist',async(req,res)=>{
  try {
    // Extract query parameter 'claims'
    const block_id = req.query.block_id;
  ...
  WdtlsRouter.get('/zonelist',async(req,res)=>{
    try {
      // Extract query parameter 'claims'
      const dist_code = req.query.dist_code;
  ...
  WdtlsRouter.get('/rangelist',async(req,res)=>{
    try {
      // Extract query parameter 'claims'
      const dist_code = req.query.dist_code;
  ...
  WdtlsRouter.get('/getsuggestions',async(req,res)=>{
    try {
      // Extract query parameter 'claims'
  ...
  WdtlsRouter.get('/distlist',async(req,res)=>{
    try {
      // Extract query parameter 'claims'
...
WdtlsRouter.get('/modifiedlist', async(req, res) => {
    try {
        // Extract range_id from session
        const range_id = req.session.user.range_id;
